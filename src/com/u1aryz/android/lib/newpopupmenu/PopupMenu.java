...
public class PopupMenu {
    ...
    public PopupMenu(Context context) {
        ...
        setContentView(mInflater.inflate(R.layout.anpm_popup_menu, null));
    }
    ...
    private void preShow() {
        ...
        mPopupWindow.setBackgroundDrawable(mContext.getResources().getDrawable(R.drawable.anpm_panel_background));
    }
    ...
    private class MenuItemAdapter extends ArrayAdapter<MenuItem> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ViewHolder holder;
            if (convertView == null) {
                convertView = mInflater.inflate(R.layout.anpm_menu_list_item, null);
